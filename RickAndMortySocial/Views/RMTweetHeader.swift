...
protocol RMTweetHeaderDelegate: AnyObject {
    func showActionSheet()
}

class RMTweetHeader: UICollectionReusableView {
    ...
    weak var delegate: RMTweetHeaderDelegate?
